...
#define HILIGHT_BORDER_TOP rgb(204, 53, 149)
#define HILIGHT_GRADIENT_TOP rgb(236, 93, 222)
#define HILIGHT_GRADIENT_BOTTOM rgb(220, 56, 212)
#define HILIGHT_BORDER_BOTTOM rgb(167, 47, 163)
